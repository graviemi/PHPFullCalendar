...
--
-- Host: localhost    Database: phpFullCalendar
-- ------------------------------------------------------
...
--
-- Table structure for table `calendarACL`
--
...
--
-- Table structure for table `globalACL`
--
...
--
-- Table structure for table `resourceAttribut`
--
...
--
-- Table structure for table `ressourceACL`
--
